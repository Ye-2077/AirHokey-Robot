...
robot = robot(23.5,23.5,33,33,25)
...
draw_circle_with_inverse_kinematics(robot, center_x, center_y, radius)
...
# Example usage:
start_point = (10,40)  # Start point of the line (x, y)
end_point = (25,40)   # End point of the line (x, y)
num_points = 100        # Number of points to interpolate along the line
# draw_line_with_inverse_kinematics(robot, *start_point, *end_point, num_points)